              ...
              <div className="flex-1 p-16 flex flex-col gap-8">
                ...
                <div className="grid grid-cols-2 gap-10 mt-2">
                  <div className="flex flex-col gap-4 text-slate-600 text-lg leading-relaxed font-light">
                    <p>
                      Current market solutions are disjointed, leading to
                      inefficiencies in the sales pipeline.
                    </p>
                    <ul className="list-disc pl-5 space-y-3 mt-2 text-base">
                      <li>
                        ...
                        of time wasted on manual entry
                      </li>
                ...
                >
                  ...
                  >
                    <div className="p-3 scale-[0.25] origin-top-left w-[400%] h-[400%] absolute top-0 left-0 pointer-events-none">
                      ...
                      {slide.id === 0 && (
                        <div className="mt-6 h-3 w-40 bg-slate-900" />
                      )}
                      {slide.id === 1 && (
                      ...
                      {slide.id === 3 && (
                        <div className="mt-6 w-full h-40 bg-slate-100 rounded" />
                      )}
                    </div>
                    {activeSlide === slide.id && (
                  ...
                  <span
                    className={`text-center text-[10px] font-medium ${activeSlide === slide.id ? "text-slate-900 font-bold" : "text-slate-500"}`}
                  >
                    {slide.label}
                  </span>
                </div>
